...
Feel free to [browse open issues](https://github.com/grafana/grafana-cloud-monitoring-datasource/issues) or open a new one. For more general guidance, see [Grafana's Contributing Guide](https://github.com/grafana/grafana/blob/main/CONTRIBUTING.md).
...
`npm run server` starts a local Google Cloud Monitoring instance and a Grafana instance with the plugin pre-provisioned:
